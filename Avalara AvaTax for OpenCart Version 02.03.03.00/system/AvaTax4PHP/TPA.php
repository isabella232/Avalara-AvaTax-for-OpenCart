...
//Changed $_SESSION['token'] to $_SESSION['default']['token']. As OpenCart 2.1.0.1 onwards doesn't have any value in $_SESSION['token']
if(!isset($_SESSION['default']['token']) || ($_SESSION['default']['token']==""))
{
	die('Access denied'); 
}
